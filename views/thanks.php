    ...
    <section class="mw--1440 py-4 px-4 px-md-5">
        <div class="grid--2cols">
            <div class="p-4 p-lg-5 align-content-center">
                <h2 class="poppins-bold text--xl mb-2">¡Gracias por confiar en nosotros! </h2>
                <p class="poppins-regular text--sm mb-5">Tu solicitud ha sido recibida con éxito. Pronto nos pondremos en contacto contigo.</p>
            ...
            <div class="p-4 p-lg-5 text-center align-content-center">
                <img src="<?php echo __ROOT__; ?>/public/img/thanks.png" alt="404" class="w-100 mw--400">
            </div>
        </div>
    </section>
</main>
